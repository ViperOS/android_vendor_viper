...
public class ColorUtils {
    ...
    public static void setColorViewValue(ImageView imageView, int color, boolean selected, ColorShape shape) {
        ...
        int darkenedColor = color == Color.parseColor("#000000") ? Color.parseColor("#6C6C6C"): Color.rgb(
    ...
    public static void showDialog(Context context, ColorDialog.OnColorSelectedListener listener, String tag,
        ...
        showDialog(context, listener, tag, numColumns, colorShape, colorChoices, selectedColorValue, null);
    }

    public static void showDialog(Context context, ColorDialog.OnColorSelectedListener listener, String tag,
                                  int numColumns, ColorShape colorShape, int[] colorChoices, int selectedColorValue, String dialogTitle) {
        ColorDialog fragment = ColorDialog.newInstance(numColumns, colorShape, colorChoices, selectedColorValue, dialogTitle);
