...
public class ColorDialog extends DialogFragment {
    ...
    public static ColorDialog newInstance(int numColumns, ColorShape colorShape, int[] colorChoices, int selectedColorValue, String dialogTitle) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle((dialogTitle == null || dialogTitle.isEmpty()) ? getContext().getString(R.string.color_picker_default_dialog_title) : dialogTitle);

        builder.setPositiveButton(R.string.color_picker_close_dialog, new DialogInterface.OnClickListener() {
    ...
    public static class Builder {
        ...
        protected ColorDialog build() {
            ColorDialog dialog = ColorDialog.newInstance(numColumns, colorShape, colorChoices, selectedColor, dialogTitle);
