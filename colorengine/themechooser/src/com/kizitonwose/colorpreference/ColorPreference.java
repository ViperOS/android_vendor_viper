...
public class ColorPreference extends Preference {
    ...
    private ColorDialog.OnColorSelectedListener dialogListener;
    ...
    private void initAttrs(AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            dialogTitle = a.getString(R.styleable.ColorPreference_dialogTitle);
    ...
    public void setColorsArray(int[] colorChoices) {
        this.colorChoices = colorChoices;
    }

    public void setOnColorSelectedListener(ColorDialog.OnColorSelectedListener listener) {
        this.dialogListener = listener;
        if (showDialog) {
            ColorUtils.attach(getContext(), dialogListener, getFragmentTag());
        }
    }
    ...
    protected void onClick() {
        super.onClick();
        if (showDialog) {
            ColorUtils.showDialog(getContext(), dialogListener, getFragmentTag(),
                    numColumns, colorShape, colorChoices, getValue(), dialogTitle);
        }
    }
